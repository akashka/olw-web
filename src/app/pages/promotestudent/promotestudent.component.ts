...
@Component({
  selector: 'promotestudent',
  templateUrl: './promotestudent.component.html',
  styleUrls: ['./promotestudent.scss'],
})
...
export class PromotestudentComponent {
  ...
  ngOnInit() {
    ...
    this.studentService.getStudents().then((data) => {
      ...
      this.student.is_Confirmed = false;
      ...
      if (this.student.class_group === 'UKG') { this.student.class_group = 'UKG'; }
      if (this.student.class_group === 'LKG') { this.student.class_group = 'UKG'; }
